...
• Подробные отчёты в Excel с 3 листами
• Автоматические уведомления
• Реферальная программа

📊 <b>Ограничения:</b>
Максимум <b>{format_number(max_size)}</b> подписок/подписчиков на аккаунт.
...
• Результат формируется в виде Excel-отчёта с 3 листами
• Время обработки зависит от размера аккаунта

<b>5. Ограничения</b>
• Сервис работает только с публичными аккаунтами
• Максимальный размер аккаунта: {format_number(max_size)} подписок/подписчиков
